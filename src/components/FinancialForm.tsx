  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full px-4 py-4 text-lg border-2 border-gray-700 rounded-xl focus:outline-none focus:ring-4 focus:ring-red-900/50 focus:border-red-400 transition-all bg-gray-900/50 text-white placeholder-gray-500"
          />
      ...
      >
        <button
          onClick={onBack}
          className="flex-1 bg-gray-700 text-gray-300 py-4 px-6 rounded-xl font-semibold text-lg flex items-center justify-center space-x-2 hover:bg-gray-600 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
        >
        ...
        <button
          onClick={onNext}
          className="flex-1 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white py-4 px-6 rounded-xl font-semibold text-lg flex items-center justify-center space-x-2 hover:from-emerald-700 hover:to-cyan-700 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-emerald-500/20"
        >
