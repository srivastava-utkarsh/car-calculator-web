    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-8 pr-4 py-4 text-lg border-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-emerald-900/50 transition-all bg-gray-900/50 text-white placeholder-gray-500 ${
              errors.carPrice 
      ...
      >
        <label className="flex items-center space-x-2 text-lg font-semibold text-white mb-4">
          ...
          {downPaymentPercentage > 0 && (
            <span className="text-sm text-gray-500">({downPaymentPercentage.toFixed(1)}%)</span>
          )}
        </label>
        <div className="relative">
          <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg">₹</span>
          <input
            ...
            className={`w-full pl-8 pr-4 py-4 text-lg border-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-cyan-900/50 transition-all bg-gray-900/50 text-white placeholder-gray-500 ${
              errors.downPayment 
                ? 'border-red-500 focus:border-red-500' 
      ...
      >
        <button
          ...
          className="w-full bg-gradient-to-r from-emerald-600 to-cyan-600 text-white py-4 px-6 rounded-xl font-semibold text-lg flex items-center justify-center space-x-2 hover:from-emerald-700 hover:to-cyan-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-emerald-500/20"
        >
